...
subroutine lanczos_memo_new(sys,env,sys_bs,env_bs,super,eigvec,levels,num_idx)
	...
	integer,parameter :: loop_out=1,loop_in=100
	...
	if(levels==1) then
		write(11,*) "Sys_len=",eigvec(1)%sys_len,"E0=",(Energys(i),i=1,levels),"Iter=",iter,"time=",end_time-bg_time
	endif
	close(11)
